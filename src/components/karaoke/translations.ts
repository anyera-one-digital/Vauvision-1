  ...
  ru: {
    ...
    info: {
      ...
      hintRules: [
        ...
        'Знаки препинания в конце строк удаляются автоматически (скобки сохраняются)',
  ...
  en: {
    ...
    info: {
      ...
      hintRules: [
        ...
        'Trailing punctuation is removed automatically (parentheses are kept)',
  ...
  es: {
    ...
    info: {
      ...
      hintRules: [
        ...
        'La puntuación final se elimina automáticamente (los paréntesis se mantienen)',
